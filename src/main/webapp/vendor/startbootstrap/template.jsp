  ...
  <%@ taglib uri="http://java.sun.com/jsp/jstl/core" prefix="c" %>
    ...
    <head>
      ...
      <meta name="google-signin-client_id"
        content="481850485040-odsbllmpvqp6h3vt08qnpppec149k216.apps.googleusercontent.com">
            ...
            <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
              ...
              <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                  <a class="nav-link dropdown-toggle" href="#" id="user-info" role="button" data-toggle="dropdown"
                    aria-haspopup="true" aria-expanded="false">
                    <div class="g-signin2" data-onsuccess="onSignIn"></div>
                  </a>
                  <!-- Dropdown - Logout Modal Trigger -->
                  <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="user-info"
                    id="user-dropdown" hidden>
